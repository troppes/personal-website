...
export async function load() {
    try {
        ...
        const posts = postsRes.data.map((/** @type {{ id: { toString: () => any; }; title: any; image: string; short_description: any; date_created: string; user_created: { first_name: any; last_name: any; }; }} */ post) => ({
            id: post.id.toString(),
            title: post.title,
